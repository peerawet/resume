...
1. Resume ของ user ใหม่: บังคับ bilingual en/th เหมือนของเจ้าของ หรือภาษาเดียวแล้วเพิ่มได้?
2. Landing page (`/`) เอาแบบไหน — ชี้ไป resume ของเจ้าของ หรือหน้าโปรโมท SaaS?
3. ชื่อ product / โดเมน?
